...
# Clock arithmetic lives in gtfstime.py — it needs no pydantic, and
# tying it to this module forced the dependency on everyone who wanted
# to format a time. Re-exported so existing imports keep working.
from transit.verify.gtfstime import GTFS_TIME, to_civil, to_seconds  # noqa: F401
